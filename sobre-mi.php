        ...
        <section class="container" id="descripcion">
            <div class="row">
                <div class="col-12 col-sm-7">
                    ...
                    <p>Soy desarrollador de programación Full Stack y de Base de datos.
                    Afín al área tecnológica tanto en dispositivos como en programación.</p>
                ...
                <div class="col-10 col-sm-3 py-5 pe-5 d-none d-sm-block">
                    <img src="images/mati.jpg" alt="mati" class="img-fluid">
                </div>
            </div>
        </section>
        <section id="stack">
                    ...
                    <div class="col-12 col-sm-6">
                        <div class="row">
                            ...
                            <div class="col-12- col-sm-10 p-3">
                                ...
                                <h4>Facultad de Ingeniería, UNCuyo</h4>
            ...
            <div class="container">
                <div class="row py-5 mx-0">
                    <div class="col-sm-6 col-12 pb-3 pb-sm-0">
                        <div class="row mr-sm-1 bg-white card-idiomas shadow me-sm-1">
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="row ml-sm-2 bg-white card-idiomas shadow ms-sm-1">
                            ...
                            <div class="col-8 pt-5 px-5">
                                ...
                                <ul>
                                    <li>Lectura</li>
                                    <li>Deporte en equipo: Fútbol</li>
                                </ul>
                            </div>
                        </div>
                    </div>
